...
public class FlexibleTripleStack {
    ...
    public String toString() {
        ...
        for (int i = 0; i < 3; i++) {
            sb.append("/ ");
            for (int j = this.head_for[i]; 
                 j < (i >= 2 ? (this.length_arr) : (this.head_for[i+1])); 
                 j++) {
